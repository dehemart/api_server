...
import 'package:api_server/api/routes/profile_route.dart';
import 'package:api_server/api/routes/sign_in_route.dart';
import 'package:api_server/api/routes/sign_out_route.dart';
...
class Routes {
  Handler handler() {
    Router protectedRouter = Router()
      ...
      ..get('/profile', ProfileRoute().handler)
      ..post('/signout', SignOutRoute().handler);
